...
export const UI_ICON_DEFINITIONS = {
  ...
  chevronRight: { lucide: ChevronRight, emoji: '▶️', usage: 'collapsed disclosure groups' },
  ...
  dragHandle: { lucide: GripVertical, emoji: '⠿', usage: 'drag-to-reorder handles' },
  ...
  fitBounds: { lucide: Fullscreen, emoji: '🔲', usage: 'zoom/pan to fit all content' },
