...
- **Traffic Management telemetry** from supported firmware now renders as labelled graphs. **Compatibility correction:** released 2.7.x firmware does not contain the module; Traffic Management requires firmware 2.8.0+.
