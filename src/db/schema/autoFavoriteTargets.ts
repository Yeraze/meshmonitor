...
export const autoFavoriteTargetsSqlite = sqliteTable('auto_favorite_targets', {
  ...
  // Max age of an on-file NeighborInfo record before we re-request it (hours).
  maxNeighborAgeHours: integer('maxNeighborAgeHours').notNull().default(24),
...
export const autoFavoriteTargetsPostgres = pgTable('auto_favorite_targets', {
  ...
  maxNeighborAgeHours: pgInteger('maxNeighborAgeHours').notNull().default(24),
...
export const autoFavoriteTargetsMysql = mysqlTable('auto_favorite_targets', {
  ...
  maxNeighborAgeHours: myInt('maxNeighborAgeHours').notNull().default(24),
