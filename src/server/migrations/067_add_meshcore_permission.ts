 ...
 */
export async function runMigration067Postgres(_client: import('pg').PoolClient): Promise<void> {
 ...
 */
export async function runMigration067Mysql(_pool: import('mysql2/promise').Pool): Promise<void> {
