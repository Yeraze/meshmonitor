...
const POSTGRES_CREATE = `
  ...
  CREATE TABLE user_notification_preferences (
    ...
    "notifyOnWaypoint" BOOLEAN DEFAULT FALSE,
    "waypointRadiusKm" DOUBLE PRECISION DEFAULT 10,
    "waypointCenterLat" DOUBLE PRECISION,
    "waypointCenterLon" DOUBLE PRECISION,
...
const MYSQL_CREATE = `
  ...
  CREATE TABLE user_notification_preferences (
    ...
    notifyOnWaypoint BOOLEAN DEFAULT FALSE,
    waypointRadiusKm DOUBLE DEFAULT 10,
    waypointCenterLat DOUBLE,
    waypointCenterLon DOUBLE,
    notifyOnServerEvents BOOLEAN DEFAULT FALSE,
    prefixWithNodeName BOOLEAN DEFAULT FALSE,
    appriseEnabled BOOLEAN DEFAULT TRUE,
    appriseUrls TEXT,
