...
export const userMapPreferencesSqlite = sqliteTable('user_map_preferences', {
  ...
  mapTilesetLight: text('map_tileset_light'),
  mapTilesetDark: text('map_tileset_dark'),
...
export const userMapPreferencesPostgres = pgTable('user_map_preferences', {
  ...
  mapTilesetLight: pgText('map_tileset_light'),
  mapTilesetDark: pgText('map_tileset_dark'),
...
export const userMapPreferencesMysql = mysqlTable('user_map_preferences', {
  ...
  mapTilesetLight: myVarchar('map_tileset_light', { length: 255 }),
  mapTilesetDark: myVarchar('map_tileset_dark', { length: 255 }),
